...
with open(r"X:\GitHub\QSpider\Python Full Stack Development\Advanced Python\09_File_Handling\json Parsing\parsing-by-json.txt", 'w') as a:
    a = a.write(b)
...
#Receiver:
with open(r"X:\GitHub\QSpider\Python Full Stack Development\Advanced Python\09_File_Handling\json Parsing\parsing-by-json.txt", 'r') as a:
    a = a.read()
    b = json.loads(a)
    print(a, type(a))
    print(b, type(b))
